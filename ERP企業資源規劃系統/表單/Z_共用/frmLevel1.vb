...
#Region "@Form及功能操作@"
    Private Sub frmLevel1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        '物件初始化*****        
        '寬
        ...
        FillData("") '載入資料集        
    End Sub
    Private Sub frmLevel1_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
#Region "DataGridView及ComboBox"
    ...
    Sub DataGridView_Basic()
        '欄位名稱
        Dim arrColName() As String = {"代碼", "名稱"}
        Dim arrColWidth() As String = {"100", "300"}
...
#Region "共用底層"
    ...
    Public Overrides Sub SetControls(ByVal butStatus As Integer)
        ...
        Dim objTextBox1() As TextBox = {M_TextBox2}
    ...
    Public Overrides Function InsertData() As Boolean
        ...
        '開啟儲存*****
        strIRow = "一層代碼,一層名稱,類別,"
        strIRow &= "建立人員,建立日期,修改人員,修改日期"

        strIValue = "'" & M_TextBox1.Text & "','" & M_TextBox2.Text & "','" & txtPage.Text & "',"
...
#Region "資料查詢"
    ...
    Function strPageName(ByVal strPage As String) As String
        ...
        Select Case strPage
            Case "S01N0001" : strName = "廠別" : 編碼說明.Text = ""
            Case "S01N0002" : strName = "部門" : 編碼說明.Text = ""
            Case "S01N0003" : strName = "僱用性質" : 編碼說明.Text = ""
            Case "S01N0004" : strName = "職稱" : 編碼說明.Text = ""
            Case "S01N0005" : strName = "薪資項目" : 編碼說明.Text = "(加項：Axx 減項：Dxx)"
            Case "S01N0007" : strName = "假別" : 編碼說明.Text = ""
            Case "S01N0008" : strName = "獎金項目" : 編碼說明.Text = ""

            Case "S02N0001" : strName = "客戶種類" : 編碼說明.Text = ""
            Case "S02N0002" : strName = "廠商種類" : 編碼說明.Text = ""
            Case "S02N0003" : strName = "付款方式" : 編碼說明.Text = ""
            Case "S02N0004" : strName = "貨幣" : 編碼說明.Text = ""
            Case "S02N0005" : strName = "加工廠種類" : 編碼說明.Text = ""
            Case "S02N0006" : strName = "加工廠區域" : 編碼說明.Text = ""

            Case "S03N0005" : strName = "長度對照" : 編碼說明.Text = ""
            Case "S03N0006" : strName = "加工方式" : 編碼說明.Text = ""
            Case "S03N0008" : strName = "表面處理" : 編碼說明.Text = ""
            Case "S03N0009" : strName = "電鍍別" : 編碼說明.Text = ""
            Case "S03N0010" : strName = "單位" : 編碼說明.Text = ""
            Case "S04N0001" : strName = "製造備註" : 編碼說明.Text = ""
            Case "S04N0004" : strName = "品管備註" : 編碼說明.Text = ""
