...
Public Class S06R0100
#Region "單用變數"
    Dim FRreport As New Report
    Dim DNS As String = INI_Read("CONFIG", "SET", "DNS") 'DNS設定值
#End Region
    Private Sub S06R0100_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Width = 900
        Me.Height = 600
    ...
    Private Sub btnPreviewRep_Click(sender As System.Object, e As System.EventArgs) Handles btnPreviewRep.Click
        ...
        FRreport.Load(ReportDir + "應收帳款總表.frx")
        FRreport.SetParameterValue("ConnStr", INI_Read("CONFIG", "SET", "DNS"))
        'FRreport.SetParameterValue("RepKey", 爐號.SelectedValue)
        FRreport.SetParameterValue("RepKey1", strSystemToDate(請款日期1.Value.ToShortDateString))
        FRreport.SetParameterValue("RepKey2", strSystemToDate(請款日期2.Value.ToShortDateString))
        FRreport.Prepare()
