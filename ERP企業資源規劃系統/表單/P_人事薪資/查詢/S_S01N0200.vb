Public Class S_S01N0200
#Region "@Form及功能操作@"
    Private Sub S_S01N0200_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        '物件初始化*****
    ...
    Private Sub btnDefine_Click(sender As System.Object, e As System.EventArgs) Handles btnDefine.Click
        ...
        '查詢條件        
        If S_TextBox1.Text <> "" Then strSQL &= " AND m.司機代號 LIKE '%" & S_TextBox1.Text & "%'"
