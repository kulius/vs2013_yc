...
#Region "@Form及功能操作@"
    Private Sub S02N0201_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        '物件初始化*****        
        '寬
    ...
    Public Overrides Sub FindWindows()
        Dim S_S02N0201 As New S_S02N0201

        '開啟視窗
        S_S02N0201.MdiParent = fmMain
        S_S02N0201.Show()
    End Sub
    ...
    Public Overrides Sub PrintWindows()
        ...
        strSSQL &= " WHERE 1=1 AND 加工廠類型 = 'A'" '前加工廠資料
...
#Region "共用底層"
    ...
    Public Overrides Function InsertData() As Boolean
        ...
        '代號是否有重複
        If dbDataCheck(DNS, "加工廠主檔", "加工廠類型 = 'A' AND 加工廠代號 = '" & 加工廠代號.Text & "'") = True Then MsgBox("系統訊息：【加工廠代號】已有相同之資料!!", MsgBoxStyle.Exclamation, "注意") : blnCheck = False
        ...
        strIValue = "'" & 加工廠代號.Text & "','A','" & 分類代碼.SelectedValue & "','" & 所屬區域代碼.SelectedValue & "','" & 統一編號.Text & "','" & 負責人.Text & "','" & 公司名稱.Text & "','" & 公司抬頭.Text & "','" & 簡稱.Text & "',"
    ...
    Public Overrides Function UpdateData() As Boolean
        ...
        '相關聯絡人檔
        '先刪
        dbDelete(DNS, "相關聯絡人檔", "種類 = 'P' AND 代號 = '" & 原加工廠代號.Text & "'")
        '後加
        For I As Integer = 0 To Tab3_DataGridViewR1.RowCount - 1 Step 1
            Dim strRowValue() As String = {Tab3_DataGridViewR1.Rows(I).Cells("聯絡人員").Value,
                                           Tab3_DataGridViewR1.Rows(I).Cells("分機").Value,
    ...
    Public Overrides Sub DeleteData()
        ...
        blnCheck = dbDelete(DNS, "相關聯絡人檔", "種類 = 'P' AND 代號 = '" & 原加工廠代號.Text & "'")
