...
Public Class S03N0191
#Region "單用變數"
    Dim FRreport As New Report
    Dim DNS As String = INI_Read("CONFIG", "SET", "DNS") 'DNS設定值
#End Region
    Private Sub S03N0191_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Width = 900
        Me.Height = 600
    ...
    Private Sub btnPreviewRep_Click(sender As System.Object, e As System.EventArgs) Handles btnPreviewRep.Click
        ...
        FRreport.Load(ReportDir + "客戶進貨統計表.frx")
        FRreport.SetParameterValue("ConnStr", INI_Read("CONFIG", "SET", "DNS"))
        'FRreport.SetParameterValue("RepKey", 爐號.SelectedValue)
        FRreport.SetParameterValue("RepKey1", strSystemToDate(進貨日期1.Value.ToShortDateString))
        FRreport.SetParameterValue("RepKey2", strSystemToDate(進貨日期2.Value.ToShortDateString))
        FRreport.Prepare()
